...
module SPI_Master_v2_50_0 (
	...
	cy_clock_v1_0
		#(.id("0d933ec6-1b6a-48a5-9fd7-f5fea1b310e0/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("250000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [7:0] tmpOE__DLow_DB_net;
	wire [7:0] tmpIO_7__DLow_DB_net;
	wire [0:0] tmpINTERRUPT_0__DLow_DB_net;
	electrical [0:0] tmpSIOVREF__DLow_DB_net;
	...
	cy_psoc3_pins_v1_10
		...
		DLow_DB
		 (.oe(tmpOE__DLow_DB_net),
		  .y({Net_111[7:0]}),
		  .fb({Net_139[7:0]}),
		  .io({tmpIO_7__DLow_DB_net[7:0]}),
		  .siovref(tmpSIOVREF__DLow_DB_net),
		  .interrupt({tmpINTERRUPT_0__DLow_DB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DLow_DB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_110, Net_110, Net_110, Net_110, Net_110, Net_110, Net_110, Net_110} : {Net_110, Net_110, Net_110, Net_110, Net_110, Net_110, Net_110, Net_110};
	...
	wire [7:0] tmpOE__DHigh_DB_net;
	wire [7:0] tmpIO_7__DHigh_DB_net;
	wire [0:0] tmpINTERRUPT_0__DHigh_DB_net;
	electrical [0:0] tmpSIOVREF__DHigh_DB_net;

	cy_psoc3_pins_v1_10
		#(.id("ba0564db-8e40-4550-b087-8e7c4367c991"),
		  .drive_mode(24'b110_110_110_110_110_110_110_110),
		  .ibuf_enabled(8'b1_1_1_1_1_1_1_1),
		  .init_dr_st(8'b0_0_0_0_0_0_0_0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(16'b00_00_00_00_00_00_00_00))
		DHigh_DB
		 (.oe(tmpOE__DHigh_DB_net),
		  .y({Net_263[7:0]}),
		  .fb({Net_6[7:0]}),
		  .io({tmpIO_7__DHigh_DB_net[7:0]}),
		  .siovref(tmpSIOVREF__DHigh_DB_net),
		  .interrupt({tmpINTERRUPT_0__DHigh_DB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DHigh_DB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_110, Net_110, Net_110, Net_110, Net_110, Net_110, Net_110, Net_110} : {Net_110, Net_110, Net_110, Net_110, Net_110, Net_110, Net_110, Net_110};
	...
	cy_psoc3_pins_v1_10
		#(.id("26ed46ad-79fc-4383-9ebb-8e8fa8b02379"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c25f8066-d4ef-45d6-a0d4-dea07e6222f2"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("70d32d3e-e243-4aef-8517-b4da286abbaa"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c7f63aac-0f7e-4fe5-a2e5-9888494706dc"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
